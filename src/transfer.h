...
enum transfer_state { TRANSFER_STATE_IDLE = 0, TRANSFER_STATE_RESOLVING, TRANSFER_STATE_CONNECTING, TRANSFER_STATE_TRANSFERRING, TRANSFER_STATE_COMPLETED, TRANSFER_STATE_FAILED };
