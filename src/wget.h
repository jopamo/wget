...
#define BOUNDED_EQUAL(beg, end, string_literal) ((end) - (beg) == sizeof(string_literal) - 1 && !memcmp(beg, string_literal, sizeof(string_literal) - 1))

/* The same as above, except the comparison is case-insensitive. */
#define BOUNDED_EQUAL_NO_CASE(beg, end, string_literal) ((end) - (beg) == sizeof(string_literal) - 1 && !c_strncasecmp(beg, string_literal, sizeof(string_literal) - 1))
